export const Bio = {
    ...
    description:
      "Motivated React developer with a strong foundation in Full Stack Development and a passion for creating intuitive and visually appealing user interfaces.",
    github: "https://github.com/ketansahugit",
    resume:
      "https://drive.google.com/file/d/11tbdEWa82p_ygh_A_2_2YeEO5ALfRyhY/view?usp=drivesdk",
    linkedin: "https://www.linkedin.com/in/ketan-sahu-9594aa232?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  ...
  export const experiences = [
    {
      ...
      desc: "During my internship at Physics Wallah Pvt Ltd, I developed a movie recommendation website using React. The project focused on fetching data from an API to provide accurate movie recommendations based on user-selected categories.",
      skills: [
        "JavaScript",
        "React Js",
        "Node Js",
  ...
  export const education = [
    ...
    },
    {
      ...
      grade: "8.48 CGPA",
      desc: "Studied accounting, economics, business management, marketing, finance, business law, statistics, and information technology, gaining a solid foundation in business disciplines.",
      degree: "Bachelor of Commerce",
    },
    {
      id: 2,
      ...
      grade: "68.3%",
      desc: "I completed my class 12 high school education at Brijlal Biyani Science College, Amravati, where I studied Book-Keeping and Accountancy.",
      degree: "HSC(XII), Commerce",
    },
    {
      id: 3,
      img: "https://firebasestorage.googleapis.com/v0/b/flexi-coding.appspot.com/o/methodist.png?alt=media&token=018a1b18-e2dd-4f34-8855-cff1b6b69fd3",
      school: "Maheshwari Vidyalaya, Amravati",
      date: "April 2015 - March 2016",
      grade: "68.2%",
      desc: "I completed my class 10 education at Maheshwari School, Amravati, where I studied Science with Computer Application.",
      degree: "SSC(X)",
    },
  ];
